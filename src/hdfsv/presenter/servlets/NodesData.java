...
public class NodesData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendError(404, "An error occured while trying to access Hadoop Metadata. Possible solutions : \n - Check that Hadoop is started \n - Check that HADOOP_CONF is correctly set, it is currently set to this path : "+cf);
		}
