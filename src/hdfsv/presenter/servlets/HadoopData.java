...
public class HadoopData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendError(404, "An error occured while trying to access Hadoop Metadata. Possible solutions : <br> - Check that Hadoop is started <br> - Check that HADOOP_CONF is correctly set, it is currently set to this path : "+cf);
		}
